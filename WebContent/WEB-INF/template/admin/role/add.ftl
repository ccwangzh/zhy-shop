		...
		<table class="input">
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						<label>
							<input type="checkbox" name="authorities" value="admin:store" />${message("admin.role.store")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:storeCategory" />${message("admin.role.storeCategory")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:storeRank" />${message("admin.role.storeRank")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:cash" />${message("admin.role.cash")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:categoryApplication" />${message("admin.role.categoryApplication")}
						</label>
					</span>
				</td>
			</tr>
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:orderPayment" />${message("admin.role.orderPayment")}
						</label>
						<label>
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:businessAttribute" />${message("admin.role.businessAttribute")}
						</label>
						<label>
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:promotionPlugin" />${message("admin.role.promotionPlugin")}
						</label>
						<label>
