...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.promotionPlugin.list")} <span>(${message("admin.page.total", promotionPlugins?size)})</span>
	</div>
