...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.orderPayment.view")}
	</div>
	<table class="input">
		<tr>
			<th>
		...
		<tr>
			...
			<th>
				${message("OrderPayment.operator")}:
			</th>
			<td>
				${orderPayment.operator.username!"-"}
			</td>
		</tr>
		<tr>
			<th>
