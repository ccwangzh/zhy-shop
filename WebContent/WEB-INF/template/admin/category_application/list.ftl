...
<body>
	...
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.categoryApplication.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as categoryApplication]
				<tr>
					...
					<td>
						<a  [#if categoryApplication.status != "pending"]class="review disabled" href="javascript:;"[#else]href="javascript:$.review(${categoryApplication.id});"[/#if]>[${message("admin.common.review")}]</a></span>
					</td>
				</tr>
			[/#list]
		</table>
