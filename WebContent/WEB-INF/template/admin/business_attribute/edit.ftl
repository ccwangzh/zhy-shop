...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.businessAttribute.edit")}
	</div>
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<table class="input">
			...
			[#if memberAttribute.type?? && (businessAttribute.type == "select" || businessAttribute.type == "checkbox")]
				<tr>
					<th>
						&nbsp;
					</th>
