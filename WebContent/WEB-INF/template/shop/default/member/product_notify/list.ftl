...
<title>${message("shop.member.productNotify.list")}[#if showPowered][/#if]</title>
						...
						[#list page.content as productNotify]
							<tr[#if !product_has_next] class="last"[/#if]>
								<td>
									...
									<img src="${productNotify.product.thumbnail!setting.defaultThumbnailProductImage}" class="goodsThumbnail" alt="${productNotify.product.name}" />
								</td>
								<td>
