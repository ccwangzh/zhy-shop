...
<title>${message("shop.member.message.view")}[#if showPowered][/#if]</title>
					...
					<dl>
						...
						<dd>
							<div class="[#if memberMessage.sender == member]right[#else]left[/#if]">
								...
								<span>[#if memberMessage.sender??][${memberMessage.sender.username}][#else][${message("shop.member.message.admin")}][/#if] ${memberMessage.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span>
								<div class="arrow"></div>
							</div>
						</dd>
						[#list memberMessage.replyMessages as replyMessage]
							<dd>
								<div class="[#if replyMessage.sender == member]right[#else]left[/#if]">
									...
									<span>[#if replyMessage.sender??][${replyMessage.sender.username}][#else][${message("shop.member.message.admin")}][/#if] ${replyMessage.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span>
									<div class="arrow"></div>
								</div>
							</dd>
						[/#list]
