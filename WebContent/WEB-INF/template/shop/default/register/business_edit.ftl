			...
			$.ajax({
				...
				success: function(message) {
					...
					if (message.type == "error" &&　message.content =="${message("shop.common.notLogin")}") {			
						$.redirectLogin("${base}/business_register.jhtml");
						return;
			...
			<div class="span12">
				<div class="wrap">
					<div class="main clearfix">
						...
						<form id="registerForm" action="${base}/business_register/update.jhtml" method="post">
									...
									[#list businessAttributes as businessAttribute]
										...
										[#elseif businessAttribute.type == "image" || businessAttribute.type == "licenseImage" || businessAttribute.type == "idCardImage" || businessAttribute.type == "organizationImage" || businessAttribute.type == "taxImage"]
											<tr>
												...
												<td>
													<span class="fieldSet">
														<input type="hidden" name="businessAttribute_${businessAttribute.id}" value="${business.getAttributeValue(businessAttribute)}" />
														<a href="javascript:;" class="button browserButton">${message("shop.common.upload")}</a>
														<span class="preview">[#if business.getAttributeValue(businessAttribute)??]<a href="${business.getAttributeValue(businessAttribute)}" target="_blank"><img src="${business.getAttributeValue(businessAttribute)}" width="56" height="56" /></a>[/#if]</span>
													</span>
												</td>
											</tr>
							...
							<table class="input tabContent">
								<tr>
									...
									<td>
										<select name="productCategoryIds" id="selectItem" multiple="multiple">
											[#list productCategoryTree as productCategory]
												<option value="${productCategory.id}" class="" [#if store.productCategorys?seq_contains(productCategory)] selected="selected" [/#if] title="${message("ProductCategory.generalRate")}:${productCategory.generalRate}">
