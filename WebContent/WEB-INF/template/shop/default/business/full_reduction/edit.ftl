...
<title>${message("shop.business.fullReduction.edit")}</title>
					...
					<form id="inputForm" action="update.jhtml" method="post">
						...
						<table class="input tabContent">
							...
							<tr>
								...
								<td>
									<label>		
										<input type="checkbox" id="useAmountPromotion" name="useAmountPromotion" value="true" [#if promotion.conditionsAmount??&&promotion.creditAmount??]checked="checked"[/#if] />${message("shop.business.fullReduction.useAmountPromotion")}
									</label>
									<label>		
										<input type="checkbox" id="useNumberPromotion" name="useNumberPromotion" value="true" [#if promotion.conditionsNumber??&&promotion.creditNumber??]checked="checked"[/#if] />${message("shop.business.fullReduction.useNumberPromotion")}
									</label>
								</td>
							</tr>
							<tr id="conditionsAmountTr" class="[#if !promotion.conditionsAmount??]hidden[/#if]">
								<th>
									${message("Promotion.conditionsAmount")}:
								</th>
								<td>
									<input type="text" id="conditionsAmount" name="conditionsAmount" class="text" value="${promotion.conditionsAmount}" maxlength="9" />
								</td>
							</tr>
							<tr id="creditAmountTr" class="[#if !promotion.creditAmount??]hidden[/#if]">
								<th>
									${message("Promotion.creditAmount")}:
								</th>
								<td>
									<input type="text" name="creditAmount" class="text" value="${promotion.creditAmount}" maxlength="9" />
								</td>
							</tr>
							<tr id="conditionsNumberTr" class="[#if !promotion.conditionsNumber??]hidden[/#if]">
								<th>
									${message("Promotion.conditionsNumber")}:
								</th>
								<td>
									<input type="text" id="conditionsNumber" name="conditionsNumber" class="text" value="${promotion.conditionsNumber}" maxlength="9" />
								</td>
							</tr>
							<tr id="creditNumberTr" class="[#if !promotion.creditNumber??]hidden[/#if]">
								<th>
									${message("Promotion.creditNumber")}:
								</th>
								<td>
									<input type="text" name="creditNumber" class="text" value="${promotion.creditNumber}" maxlength="9" />
								</td>
							</tr>
							<tr>
								<th>
								...
								<td>
									<input type="text" id="conditionsPoint" name="conditionsPoint" class="text" value="${promotion.conditionsPoint}" maxlength="9" />
								</td>
							</tr>
							<tr>
								<th>
