...
<title>${message("shop.business.deliveryTemplate.list")}[#if showPowered][/#if]</title>
			...
			<div class="span10">
				<div class="list clearfix">
					<div class="breadcrumb">
						 ${message("shop.business.deliveryTemplate.list")} <span>(${message("shop.page.total", page.total)})</span>
					</div>
						...
						<table id="listTable" class="list">
							...
							[#list page.content as deliveryTemplate]
								<tr>
									...
									<td>
										<a href="edit.jhtml?id=${deliveryTemplate.id}">[${message("shop.common.edit")}]</a>
									</td>
								</tr>
							[/#list]
						</table>
