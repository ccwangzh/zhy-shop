...
<title>${message("shop.business.deliveryTemplate.add")}[#if showPowered][/#if]</title>
			...
			<div class="span10">
				<div class="list clearfix">
					<div class="breadcrumb">
						${message("shop.business.deliveryTemplate.add")}
					</div>
					<form id="inputForm" action="save.jhtml" method="post">
						...
						<table class="input">
							...
							<tr>
								...
								<td>
									<div id="contentStyle" class="contentStyle"></div>
								</td>
							</tr>
							<tr>
								<th>
