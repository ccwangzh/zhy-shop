...
<title>${message("shop.business.categoryApplication.list")}[#if showPowered][/#if]</title>
			...
			<div class="span10">
				<div class="list clearfix">
					<div class="breadcrumb">
						${message("shop.business.categoryApplication.list")} <span>(${message("shop.page.total", page.total)})</span>
					</div>
							...
							<div class="buttonGroup">
								[#if !store.isSelfShop]
									<a href="add.jhtml" class="button">
										${message("shop.business.categoryApplication.add")}
									</a>
								[/#if]
