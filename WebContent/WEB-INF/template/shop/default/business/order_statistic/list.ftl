...
<title>${message("shop.business.orderStatistic.list")}[#if showPowered][/#if]</title>
...
<body>
	[#assign current = "orderStatisticList" /]
			...
			<div class="span10">
				<div class="list clearfix">
					<div class="breadcrumb">
						${message("shop.business.orderStatistic.list")}
					</div>
					<form id="listForm" action="list.jhtml" method="get">
						...
						<div class="bar">
							<div class="buttonGroup">
								...
								<div id="periodMenu" class="dropdownMenu">
									<a href="javascript:;" class="button">
										${message("shop.business.orderStatistic.period")}<span class="arrow">&nbsp;</span>
									</a>
									<ul class="check">
							...
							${message("shop.business.orderStatistic.beginDate")}:
							...
							${message("shop.business.orderStatistic.endDate")}:
								...
								series: [
									{
										...
										markLine: {
											data: [
												{
													name: "${message("shop.business.orderStatistic.average")}",
													type: "average"
												}
											]
										}
