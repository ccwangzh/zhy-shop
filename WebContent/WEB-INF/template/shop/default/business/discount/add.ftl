...
<title>${message("shop.business.discount.add")}</title>
					...
					<form id="inputForm" action="save.jhtml" method="post">
						...
						<table class="input tabContent">
							...
							<tr>
								...
								<td>
									<input type="text" name="discount" class="text" title="${message("shop.business.fullReduction.discountNote")}" maxlength="9" />
								</td>
							</tr>
							<tr>
								<th>
