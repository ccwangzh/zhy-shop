...
<title>${message("shop.business.discount.list")}</title>
			...
			<div class="span10">
				<div class="list clearfix">
					<div class="breadcrumb">
						${message("shop.business.discount.list")} <span>(${message("shop.page.total", page.total)})</span>
					</div>
					<form id="listForm" action="list.jhtml" method="get">
						<div class="bar">
							[#if store.isDiscount && !store.isSelf()]
						...
						<table id="listTable" class="list">
							<tr>
								...
								<th>
									<a href="javascript:;" class="sort" name="endDate">${message("Promotion.isEnabled")}</a>
								</th>
								<th>
