	...
	<div class="container goodsList">
		...
		<div class="row">
			<div class="span10" style="width: 100%;">
				<form id="goodsForm" action="${base}${(productCategory.path)!"/goods/list2.jhtml"}" method="get">
						...
						[#if page.content?has_content]
							<ul>
								[#list page.content as goods]
									...
									<li style="width: 242px;border: 1px solid #e0e0e0;margin:0 16px 20px 0;height: 210px;">
										<a href="${goods.url}">
										...
										<div class="integral">
											...
											<div class="action" style="display:inline-block;">
												...
												[#else]
													<a href="javascript:;" class="exchange" productId="${defaultProduct.id}">立即兑换</a>
												[/#if]
