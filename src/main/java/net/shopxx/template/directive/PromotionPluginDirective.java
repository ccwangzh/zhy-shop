 ...
 * @version 5.0
 */
@Component("promotionPluginDirective")
public class PromotionPluginDirective extends BaseDirective {

	/** "促销插件ID"参数名称 */
	private static final String PROMOTION_PLUGIN_PARAMETER_NAME = "promotionPluginId";
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		String promotionPluginId = FreeMarkerUtils.getParameter(PROMOTION_PLUGIN_PARAMETER_NAME, String.class, params);
