...
public class GoodsListDirective extends BaseDirective {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		List<Goods> goodsList = goodsService.findList(type, null, null, productCategoryId, brandId, promotionId, tagId, attributeValueMap, startPrice, endPrice, true, Goods.Status.onTheshelf, true, null, null, null, hasPromotion, orderType, count, filters, orders, useCache);
