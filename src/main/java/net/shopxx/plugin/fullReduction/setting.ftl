...
<title>${message("admin.plugin.fullReduction.setting")}</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.plugin.fullReduction.setting")}
	</div>
