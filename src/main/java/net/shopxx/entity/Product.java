...
public class Product extends BaseEntity<Long> {
	 ...
	 * 挂牌商品验证组
	 */
	public interface Listedtrade extends Default {
	...
	public boolean getIsActive() {
		return getGoods() != null && BooleanUtils.isTrue(getGoods().getIsActive());
	}
	 ...
	 */
	@Transient
	public BigDecimal getCommission(Store.Type type) {
		BigDecimal commission = BigDecimal.ZERO;
		if (type != null && getGoods() != null && getGoods().getProductCategory() != null) {
			ProductCategory productCategory = getGoods().getProductCategory();
