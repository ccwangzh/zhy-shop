...
public class Member extends BaseEntity<Long> {
	...
	/** 2017-06-01 add 此属性名称用来保存session中lockKey*/
	...
	/** 最大收藏店铺数 */
	public static final Integer MAX_STORE_FAVORITE_COUNT = 10;
	...
	/** 收藏店铺 */
	private Set<Store> favoriteStore = new HashSet<Store>();
	 ...
	 */
	@ManyToMany(fetch = FetchType.LAZY)
	@JoinTable(name = "xx_member_favorite_store")
	@OrderBy("createdDate desc")
	public Set<Store> getFavoriteStore() {
	 ...
	 *            收藏店铺
	 */
	public void setFavoriteStore(Set<Store> favoriteStore) {
	...
	public BigDecimal getTotalBalance() {
		...
		if (BigDecimal.ZERO.compareTo(getBalance()) < 0 || BigDecimal.ZERO.compareTo(getFrozenFunds()) < 0) {
			return totalBalance;
		}
		return getBalance().add(getFrozenFunds());
	}
