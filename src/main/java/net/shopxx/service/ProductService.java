...
public interface ProductService extends BaseService<Product, Long> {
	 ...
	 * @return 商品
	 */
	List<Product> search(Store store, Goods.Type type, String keyword, Set<Product> excludes, Integer count);
	 ...
	 *            备注
	 */
	void addStock(Product product, int amount, StockLog.Type type, Operator operator, String memo);
