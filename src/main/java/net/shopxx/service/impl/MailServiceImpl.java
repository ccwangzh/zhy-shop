...
public class MailServiceImpl implements MailService {
	...
	public void sendTestSmtpMail(String smtpHost, int smtpPort, String smtpUsername, String smtpPassword, boolean smtpSSLEnabled, String smtpFromMail, String toMail) {
		...
		send(smtpHost, smtpPort, smtpUsername, smtpPassword, smtpSSLEnabled, smtpFromMail, new String[] { toMail }, subject, templateConfig.resolveTemplatePath(), null, false);
	}
	...
	public void sendFindPasswordMail(String toMail, String username, SafeKey safeKey) {
		...
		send(toMail, subject, templateConfig.resolveTemplatePath(), model);
	}
	...
	public void sendProductNotifyMail(ProductNotify productNotify) {
		...
		send(productNotify.getEmail(), subject, templateConfig.resolveTemplatePath(), model);
	}
	...
	public void sendRegisterMemberMail(Member member) {
		...
		send(member.getEmail(), subject, templateConfig.resolveTemplatePath(), model);
	}
	...
	public void sendCreateOrderMail(Order order) {
		...
		send(order.getMember().getEmail(), subject, templateConfig.resolveTemplatePath(), model);
	}
	...
	public void sendApprovalStoreMail(Store store) {
		...
		send(store.getEmail(), subject, templateConfig.resolveTemplatePath(), model);
