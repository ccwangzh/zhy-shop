...
public class ShippingMethodServiceImpl extends BaseServiceImpl<ShippingMethod, Long> implements ShippingMethodService {
	...
	@Resource(name = "defaultFreightConfigDaoImpl")
	...
	public BigDecimal calculateFreight(ShippingMethod shippingMethod, Store store, Area area, Integer weight) {
		...
		BigDecimal firstPrice = defaultFreightConfig != null ? defaultFreightConfig.getDefaultFirstPrice() : BigDecimal.ZERO;
		BigDecimal continuePrice = defaultFreightConfig != null ? defaultFreightConfig.getDefaultContinuePrice() : BigDecimal.ZERO;
