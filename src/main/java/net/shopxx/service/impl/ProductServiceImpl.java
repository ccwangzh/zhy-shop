...
public class ProductServiceImpl extends BaseServiceImpl<Product, Long> implements ProductService {
	...
	@Transactional(readOnly = true)
	public List<Product> search(Store store, Goods.Type type, String keyword, Set<Product> excludes, Integer count) {
		return productDao.search(store, type, keyword, excludes, count);
	}

	public void addStock(Product product, int amount, StockLog.Type type, Operator operator, String memo) {
