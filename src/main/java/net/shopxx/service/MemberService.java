...
public interface MemberService extends BaseService<Member, Long> {
	 ...
	 *            备注
	 */
	void addBalance(Member member, BigDecimal amount, DepositLog.Type type, Operator operator, String memo);
	 ...
	 *            备注
	 */
	void addPoint(Member member, long amount, PointLog.Type type, Operator operator, String memo);
