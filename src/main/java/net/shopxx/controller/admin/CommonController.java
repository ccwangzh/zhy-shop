...
public class CommonController implements ServletContextAware {
	...
	public String main() {
        ...
        if(!StringUtil.isEmpty(serverName) && serverName.indexOf("admin")>-1){
            serverName = serverName.replace("admin","www");
        }
	...
	public String index(ModelMap model) {
		...
		model.addAttribute("marketableProductCount", goodsService.count(null, null, null, true, Goods.Status.onTheshelf, null, null, null, null));
		model.addAttribute("notMarketableProductCount", goodsService.count(null, null, null, false, Goods.Status.offTheshelf, null, null, null, null));
		model.addAttribute("stockAlertProductCount", goodsService.count(null, null, null, null, null, null, null, null, true));
		model.addAttribute("outOfStockProductCount", goodsService.count(null, null, null, null, null, null, null, true, null));
