...
public class OrderController extends BaseController {
	...
	public @ResponseBody Map<String, Object> transitStep(String shippingSn) {
	...
	public String list(Integer pageNumber, ModelMap model,Order.Status orderStatus) {
		Member member = memberService.getCurrent();
		Pageable pageable = new Pageable(pageNumber, PAGE_SIZE);
		model.addAttribute("page", orderService.findPage(null, orderStatus, null, member, null, null, null, null, null, null, null, pageable));
	...
	public @ResponseBody Message cancel(String sn) {
		...
		orderService.cancel(order, new Operator(member));
		return SUCCESS_MESSAGE;
	}
	...
	public @ResponseBody Message receive(String sn) {
		Order order = orderService.findBySn(sn);
		if (order == null) {
			return ERROR_MESSAGE;
		}
		...
		orderService.receive(order, new Operator(member));
		return SUCCESS_MESSAGE;
	}
