...
public class ReviewController extends BaseController {
	...
	public String content(@PathVariable Long goodsId, Review.Type type, Integer pageNumber, ModelMap model) {
		Setting setting = SystemUtils.getSetting();
		if (!setting.getIsReviewEnabled()) {
			throw new ResourceNotFoundException();
		}
		...
		model.addAttribute("goods", goods);
		model.addAttribute("page", reviewService.findPage(null, goods, goods.getStore(), type, true, pageable));
	...
	public @ResponseBody Message save(String captchaId, String captcha, Long goodsId, Integer score, String content, HttpServletRequest request) {
		...
		review.setStore(goods.getStore());
