...
public class BaseController {
	...
	public ModelAndView exceptionHandler(ResourceNotFoundException resourceNotFoundException, HttpServletResponse response) {
	...
	public ModelAndView exceptionHandler(TypeMismatchException typeMismatchException, HttpServletResponse response) {
	 ...
	 * 异常处理
	 * 
	 * @param illegalLicenseException
	 *            非法商业许可
	 * @param response
	 *            HttpServletResponse
	 * @return 数据视图
	 */
	@ExceptionHandler(IllegalLicenseException.class)
	public ModelAndView exceptionHandler(IllegalLicenseException illegalLicenseException, HttpServletResponse response) {
