 ...
 * @version 5.0
 */
@Controller("shopBusinessFullReductionController")
@RequestMapping("/business/full_reduction")
public class FullReductionController extends BaseController {
	...
	public @ResponseBody Map<String, Object> checkStoreStatus() {
		...
		data.put("fullReductionTime", store.getFullReduction() != null ? store.getFullReduction() : 0);
		return data;
	}
	...
	public @ResponseBody Map<String, Object> generateSvc(Integer year) {
		...
		promotionPluginSvc.setPromotionPluginId(FULL_REDUCTION);
	...
	public String buy(ModelMap model) {
		...
		return "/shop/${theme}/business/full_reduction/buy";
	}
	...
	public @ResponseBody Map<String, Object> depositPayment(Integer year) {
		...
		storeService.buyPromotionPlugin(store, FULL_REDUCTION, year, pluginPrice);
		data.put("message", SUCCESS_MESSAGE);
		return data;
	}
	...
	public String add(ModelMap model) {
		...
		return "/shop/${theme}/business/full_reduction/add";
	}
	...
	public String save(Promotion promotion, Boolean useAmountPromotion, Boolean useNumberPromotion, Long[] memberRankIds, Long[] couponIds, Long[] giftIds, RedirectAttributes redirectAttributes) {
		...
		promotion.setType(Promotion.Type.fullReduction);
	...
	public String edit(Long id, ModelMap model) {
		...
		model.addAttribute("memberRanks", memberRankService.findAll());
		model.addAttribute("coupons", couponService.findList(store));
		return "/shop/${theme}/business/full_reduction/edit";
	}
	...
	public String update(Promotion promotion, Boolean useAmountPromotion, Boolean useNumberPromotion, Long id, Long[] memberRankIds, Long[] couponIds, Long[] giftIds, RedirectAttributes redirectAttributes) {
		Store store = storeService.getCurrent();
	...
	public String list(Pageable pageable, ModelMap model) {
		...
		model.addAttribute("page", promotionService.findPage(store, Promotion.Type.fullReduction, pageable));
		return "/shop/${theme}/business/full_reduction/list";
	}
