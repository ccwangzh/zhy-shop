...
public class ConsultationController extends BaseController {
	...
	public String content(@PathVariable Long goodsId, Integer pageNumber, ModelMap model) {
		...
		model.addAttribute("goods", goods);
		model.addAttribute("page", consultationService.findPage(null, goods, goods.getStore(), true, pageable));
	...
	public @ResponseBody Message save(String captchaId, String captcha, Long goodsId, String content, HttpServletRequest request) {
		...
		if (member.equals(goods.getStore().getBusiness().getMember())) {
			return Message.warn("shop.consultation.addConsultationNotAllowed");
		}
		...
		consultation.setStore(goods.getStore());
