...
public class Setting implements Serializable {
	...
	/** 网站keywords */
	private String siteNameKeywords;
	...
	public String getSiteNameKeywords() {
		return siteNameKeywords;
	}

	public void setSiteNameKeywords(String siteNameKeywords) {
		this.siteNameKeywords = siteNameKeywords;
	}

	public String getSiteNameDescription() {
		return siteNameDescription;
	}

	public void setSiteNameDescription(String siteNameDescription) {
		this.siteNameDescription = siteNameDescription;
	}
