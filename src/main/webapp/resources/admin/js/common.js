...
var messages = {
	"admin.message.success": "admin.message.success",
	"admin.message.error": "admin.message.error",
	"admin.dialog.ok": "admin.dialog.ok",
	"admin.dialog.cancel": "admin.dialog.cancel",
	"admin.dialog.deleteConfirm": "admin.dialog.deleteConfirm",
	"admin.dialog.clearConfirm": "admin.dialog.clearConfirm"
};
		...
		uploader: function(options) {
			...
			return this.each(function() {
				...
				var webUploader = WebUploader.create({
					...
					switch(type) {
						case "F_EXCEED_SIZE":
							$.message("warn", "admin.upload.sizeInvalid");
							break;
						case "Q_TYPE_DENIED":
							$.message("warn", "admin.upload.typeInvalid");
							break;
						default:
							$.message("warn", "admin.upload.error");
					}
				});
...
$().ready(function() {
	...
	$(document).ajaxComplete(function(event, request, settings) {
		...
		if (tokenStatus == "accessDenied") {
			...
			$.message("warn", "admin.validate.illegal");
		} else if (loginStatus == "accessDenied") {
			$.message("warn", "admin.login.accessDenied");
			setTimeout(function() {
				location.reload(true);
			}, 2000);
		} else if (loginStatus == "unauthorized") {
			$.message("warn", "admin.unauthorized.message");
		}
	});
...
if ($.validator != null) {
	...
	$.extend($.validator.messages, {
		required: 'admin.validate.required',
		email: 'admin.validate.email',
		url: 'admin.validate.url',
		date: 'admin.validate.date',
		dateISO: 'admin.validate.dateISO',
		pointcard: 'admin.validate.pointcard',
		number: 'admin.validate.number',
		digits: 'admin.validate.digits',
		minlength: $.validator.format('admin.validate.minlength'),
		maxlength: $.validator.format('admin.validate.maxlength'),
		rangelength: $.validator.format('admin.validate.rangelength'),
		min: $.validator.format('admin.validate.min'),
		max: $.validator.format('admin.validate.max'),
		range: $.validator.format('admin.validate.range'),
		accept: 'admin.validate.accept',
		equalTo: 'admin.validate.equalTo',
		remote: 'admin.validate.remote',
		integer: 'admin.validate.integer',
		positive: 'admin.validate.positive',
		negative: 'admin.validate.negative',
		decimal: 'admin.validate.decimal',
		pattern: 'admin.validate.pattern',
		extension: 'admin.validate.extension'
	});
